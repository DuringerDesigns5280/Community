...
const options = [
  { key: 'm', text: 'Male/Cis', value: 'male' },
  { key: 'f', text: 'Female/Cis', value: 'female' },
  { key: 'ftm', text: 'Trans-FTM', value: 'trans-FTM' },
  { key: 'mtf', text: 'Trans-MTF', value: 'trans-MTF' },
  { key: 'bi', text: 'Bi-Gender', value: 'bi-gender' },
  { key: 'flu', text: 'Gender-Fluid', value: 'fluid' },
  { key: 'gnc', text: 'Gender non-conforming', value: 'non-conforming' },
]
  ...
  render() {
    ...
    return (
      ...
      <h2>New users register here</h2>
        <Form.Group className='topForm' widths='equal'>
        ...
        <Form.Group inline>
          ...
          <Form.Radio
            label='Closeted'
            value='closet'
            checked={value === 'closet'}
            onChange={this.handleChange}
          />
          <Form.Radio
            label='Transitioning'
            value='transitioning'
            checked={value === 'transitioning'}
            onChange={this.handleChange}
          />
          <Form.Radio
            label='Transitioned'
            value='Transitioned'
            checked={value === 'Transitioned'}
            onChange={this.handleChange}
          />
          <Form.Radio
            label='Other'
    ...
    <Modal.Header>Community</Modal.Header>
    <Modal.Content image>
      <Image wrapped  />
      <Modal.Description>
